...
def instructions():
    """
    Shows player the instructions for the game
    """
    mixins.clear_display()
    print(f"{Fore.BLUE}{Style.BRIGHT}Welcome to Reclaim The Light")
    print(
